    ...
    <form onSubmit={handleSubmit}>
      <div className="flex flex-col items-center p-4 mx-10 border-2 border-slate-500 rounded-xl">
        ...
        <div className="flex flex-col flex-wrap content-center justify-center p-4 gap-y-4">
          ...
          <button
            className="flex flex-wrap content-center justify-center duration-100 border-2 border-blue-300 msg-btn hover:bg-blue-300 bg-slate-900 text-neutral-200 hover:border-slate-800 rounded-xl hover:text-zinc-900"
            type="submit"
          >
            Send Message
          </button>
